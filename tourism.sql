...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 14, 2022 at 04:31 PM
...
INSERT INTO `booking` (`Id`, `User_id`, `Hotel_id`, `BookingDate`, `ArrivalDate`, `LeavingDate`, `Totaldays`, `TotalRooms`, `TotalPrice`, `status`, `cancle_booking`) VALUES
(18, 7, 1, '2022-08-01', '2022-08-02', '2022-08-04', 3, 2, 18750, 1, 0),
(19, 7, 5, '2022-08-20', '2022-08-22', '2022-08-24', 3, 1, 6747, 1, 0),
(20, 7, 12, '2022-08-26', '2022-09-01', '2022-09-03', 3, 1, 14847, 0, 0),
(21, 7, 1, '2022-09-03', '2022-09-13', '2022-09-15', 3, 3, 28125, 0, 0),
(22, 7, 2, '2022-09-08', '2022-09-13', '2022-09-14', 2, 2, 8400, NULL, 0),
(24, 7, 1, '2022-09-09', '2022-09-12', '2022-09-13', 2, 1, 6250, NULL, 0),
(25, 7, 1, '2022-09-09', '2022-09-10', '2022-09-10', 1, 25, 78125, NULL, 1),
(26, 7, 1, '2022-09-13', '2022-09-16', '2022-09-23', 8, 2, 50000, NULL, 0);
...
CREATE TABLE `hotels` (
  ...
  `User_id` int(11) NOT NULL,
  `hotel_delete` int(11) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `places` (
  ...
  `place_delete` int(11) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `users` (`Id`, `Name`, `MobileNo`, `UserType`, `Email`, `Password`, `status`, `user_delete`) VALUES
(6, 'Divyrajsinh', '1234567890', 'A', 'divyrajsinh@gmail.com', 'admin', 1, 0),
(7, 'Darshan', '123467890', 'U', 'abc@gmail.com', 'darshan', 1, 0),
(12, 'Hotel Fortune Palace', '1234567891', 'H', 'HotelFortunePalace@gmail.com', 'HotelFortunePalace', 1, 0),
(13, 'Hotel Highway Hari', '9595959595', 'H', 'HotelHighwayHari@gmail.com', 'HotelHighwayHari', 1, 0),
(14, 'Hotel Foliage', '9090909090', 'H', 'HotelFoliage@gmail.com', 'HotelFoliage', 1, 0),
(15, 'Anaya Beacon Hotel', '9191919191', 'H', 'AnayaBeaconHotel@gmail.com', 'AnayaBeaconHotel', 1, 0),
(16, 'The Fern Royal Farm Resort', '9292929292', 'H', 'TheFernRoyalFarmResort@gmail.com', 'TheFernRoyalFarmResort', 1, 0),
(17, 'Ramada by Wyndham Gandhidham Shinay ', '9393939393', 'H', 'RamadabyWyndhamGandhidhamShinay@gmail.com', 'RamadabyWyndhamGandhidhamShinay', 1, 0),
(18, 'Hotel Tulsi Residency', '9494949494', 'H', 'HotelTulsiResidency@gmail.com', 'HotelTulsiResidency', 1, 0),
(19, 'The Grand Raveta\r\n', '9595959595', 'H', 'TheGrandRaveta@gmail.com', 'TheGrandRaveta', 1, 0),
(20, 'Hotel Dolphin Residency\r\n', '9696969696', 'H', 'HotelDolphinResidency@gmail.com', 'HotelDolphinResidency', 1, 0),
(21, 'Hotel The Grand Piano\r\n', '9797979797', 'H', 'HotelTheGrandPiano@gmail.com', 'HotelTheGrandPiano', 1, 0),
(22, 'Novotel Ahmedabad\r\n', '9898989898', 'H', 'NovotelAhmedabad@gmail.com', 'NovotelAhmedabad', 1, 0),
(23, 'The Fortune Landmark\r\n', '9999999999', 'H', 'TheFortuneLandmark@gmail.com', 'TheFortuneLandmark', 1, 0),
(24, 'Hawthorn Suites by Wyndham', '2121212121', 'H', 'HawthornSuitesbyWyndham@gmail.com', 'HawthornSuitesbyWyndham', 1, 0),
(25, 'THE GRAND ASTORIA SOMANTH', '9292929292', 'H', 'THEGRANDASTORIASOMANTH@gmail.com', 'THEGRANDASTORIASOMANTH', 1, 0),
(26, 'nishit', '1234567891', 'U', '1@gmail.com', '11', 1, 0),
(27, 'Alfu', '9876543210', 'U', 'alfu@gmail.com', 'alfu', 1, 0),
(28, 'div', '1234567899', 'U', '2@gmail.com', '2', 1, 1);
